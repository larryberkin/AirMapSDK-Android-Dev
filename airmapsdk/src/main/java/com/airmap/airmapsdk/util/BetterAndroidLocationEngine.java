...
public class BetterAndroidLocationEngine extends LocationEngine implements LocationListener {
    ...
    private static final String LOG_TAG = BetterAndroidLocationEngine.class.getSimpleName();
    ...
    public BetterAndroidLocationEngine(Context context) {
        ...
        for (final String provider : locationManager.getProviders(true)) {
            ...
            Log.e(LOG_TAG, "lkl for provider: " + locationManager.getLastKnownLocation(provider));

            locationManager.requestSingleUpdate(provider, new LocationListener() {
                @Override
                public void onLocationChanged(Location location) {
                    Log.e(LOG_TAG,"onLocationChanged: " + provider);
                }
...
//        if (!TextUtils.isEmpty(currentProvider)) {
            //noinspection MissingPermission
            Log.e(LOG_TAG,"requestLocationUpdates");
            locationManager.requestLocationUpdates(GPS_PROVIDER, DEFAULT_MIN_TIME, DEFAULT_MIN_DISTANCE, this);
//            locationManager.requestLocationUpdates(NETWORK_PROVIDER, DEFAULT_MIN_TIME, DEFAULT_MIN_DISTANCE, this);
//        }
    }
