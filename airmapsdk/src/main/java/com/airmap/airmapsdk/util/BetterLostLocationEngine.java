...
public class BetterLostLocationEngine extends LocationEngine implements LostApiClient.ConnectionCallbacks, LocationListener {

    private static final String TAG = "BetterLostEngine";
    ...
    public BetterLostLocationEngine(Context context) {
        super();
    ...
    public static synchronized LocationEngine getLocationEngine(Context context) {
        if (instance == null) {
            instance = new BetterLostLocationEngine(context.getApplicationContext());
        }
